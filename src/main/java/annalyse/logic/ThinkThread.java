        ...
        for (Opportunities o : op) {
            ...
            if (wop.size() > 0) {
                ...
                if (WAtt.getLanguage() == 1)
                    this.caller.answer("Tołken: \"" + wop.get(0).getLexem() + "\" mógłby by być ");
                int i = 0;
                if (outprints.contains("verbous")) {
                    for (Wort w : wop) {
                        i++;
                        if (WAtt.getLanguage() == 0) if (wop.size() == 1)
                            this.caller.answer(getArtikel(w.getWortart()) + ": " + w.toString() + " ");
                        if (WAtt.getLanguage() == 1) if (wop.size() == 1) this.caller.answer(w.toString() + " ");
                        if (WAtt.getLanguage() == 0) if (i < wop.size() - 1)
                            this.caller.answer(getArtikel(w.getWortart()) + ": " + w.toString() + ", ");
                        if (WAtt.getLanguage() == 1) if (i < wop.size() - 1) this.caller.answer(w.toString() + ", ");
                        if (WAtt.getLanguage() == 0) if (i == wop.size() - 1)
                            this.caller.answer(getArtikel(w.getWortart()) + ": " + w.toString() + " oder ");
                        if (WAtt.getLanguage() == 1)
                            if (i == wop.size() - 1) this.caller.answer(w.toString() + " lub ");
                        if (WAtt.getLanguage() == 0) if (i == wop.size() && i != 1)
                            this.caller.answer(getArtikel(w.getWortart()) + ": " + w.toString() + " ");
                        if (WAtt.getLanguage() == 1)
                            if (i == wop.size() && i != 1) this.caller.answer(w.toString() + " ");
                    }
                } else {
                    for (Wort w : wop) {
                        i++;
                        if (WAtt.getLanguage() == 0)
                            if (wop.size() == 1) this.caller.answer(getArtikel(w.getWortart()) + ": ");
                        if (WAtt.getLanguage() == 1) if (wop.size() == 1) this.caller.answer(w.toString() + " ");
                        if (WAtt.getLanguage() == 0)
                            if (i < wop.size() - 1) this.caller.answer(getArtikel(w.getWortart()) + ": ");
                        if (WAtt.getLanguage() == 1) if (i < wop.size() - 1) this.caller.answer(w.toString() + ", ");
                        if (WAtt.getLanguage() == 0)
                            if (i == wop.size() - 1) this.caller.answer(getArtikel(w.getWortart()) + ": ");
                        if (WAtt.getLanguage() == 1)
                            if (i == wop.size() - 1) this.caller.answer(w.toString() + " lub ");
                        if (WAtt.getLanguage() == 0)
                            if (i == wop.size() && i != 1) this.caller.answer(getArtikel(w.getWortart()) + ": ");
                        if (WAtt.getLanguage() == 1)
                            if (i == wop.size() && i != 1) this.caller.answer(w.toString() + " ");
                    }
                }
